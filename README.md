...
At the top level, the repository is organized into three main working areas:

| Folder | Description |
|--------|-------------|
| `data/` | Input data, intermediate files, and final analysis outputs generated by the workflow. |
...
| Folder | Description |
|--------|-------------|
| `data/raw/` | Initial input files provided by the user or project. |
...
The workflow starts from raw files provided by the sequencing/taxonomy workflow and placed in `data/raw/`. These files are not generated by this repository:
...
More details: [raw data processing README](scripts/1_raw_data_processing/readme.md)
...
More details: [abundance estimation README](scripts/2_abundance_estimation/readme.md)
...
More details: [OTU generation README](scripts/3_otu_generation/README.md)
...
More details: [OTU metrics README](scripts/4_otu_metrics/README.md)
...
More details: [metrics analysis README](scripts/5_metrics_analysis/README.md)
...
More details: [haplotype clustering README](scripts/6_haplotype_clustering/README.md)
